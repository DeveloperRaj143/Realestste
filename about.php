...
<?php include './includes/header.php'?>
	...
	<div class="viewport">
		<div id="scroll-container">
			...
			<div class="m-inner-page-content m-about">
				<div class="m-about-sec1">
				    <h1>Your Trusted Real Estate Consultant in India</h1>
					<p align="justify"><span class="text-primary">Capdeal is the best real estate Consultant in Eastern India.</span> With our tech-enabled, 360-degree best property consultation services and easy home financing options, we <a href="our-projects.html">make the journey of buying, selling residential and commercial properties really easy.</a></p>
					<p align="justify">Since our inception in 2015, we have catered to 7500+ happy clients in partnership with 50+ top Indian real estate developers, making us the leading property consultant company in Odisha. Now our company is expanding to new horizons.</p>
					<p align="justify">Driven by our commitment to reliability and transparency, we bring you a wide choice of purchases and investments tailored to suit your requirements to make your journey effortless and hassle-free. Within a short span, we have carved a niche for ourselves as the undisputed leader of the <a href="index.html">real estate service provider in Bhubaneswar</a>, helping transform expectations into an impeccable reality.</p>
				</div>
				<div class="m-about-sec2">
					<div class="m-about-sec2-img">
						<img src="img/building.jpg" alt="Building">
					</div>
					<div class="m-about-sec2-content">
						<div class="m-caption__primary__text">
							<div class="text-revel-box"><h3 class="text-revel-3">Motto of <span class="text-primary">Capdeal</span></h3></div>
							<div class="m-section__content__desc">
								<p>Our motto is to empower the real estate ecosystem with end-to-end solutions, extend services beyond buying, selling and renting, and build an everlasting relationship with people.</p>
								<p>Each project of Capdeal combines transparency and trust with a commitment to provide easy, hassle-free and excellent services.</p>
			              </div>
						</div>
						<div class="more-content">
							<h5 class="my-0">OUR VALUES</h5>
							<ul class="basic-ul">
								<li><strong>ETHICS</strong>: Committed to carrying out ethical real estate transactions</li>
								<li><strong>TRUST</strong>: Trust is the driving force of our business</li>
								<li><strong>PROGRESS</strong>: We strive to become a leading Prop-Tech company in India</li>
								<li><strong>TRANSPARENCY</strong>: Transparent dealings guaranteed</li>
								<li><strong>RESPONSIBILITY</strong>: What we commit, we deliver</li>
							</ul>
						</div>
						<div class="more-content" style="border: none;">
							<h5 class="my-0">OUR MISSION</h5>
							<ul class="basic-ul">
								<li>To integrate technology, innovation and services to deliver customer delight every time</li>
								<li>To make real estate transactions efficient and transparent</li>
								<li>To make Capdeal the go-to property management company of Odisha and pan-India</li>
							</ul>
						</div>
					</div>
				</div>
				<!-- <div class="m-section m-about-sec3">
					<div class="m-container">
						<div class="m-caption__primary__text">
				              <div class="text-revel-box"><h3 class="text-revel-3">Our <span class="text-primary">Team</span></h3></div>
				              <div class="m-section__content__desc">
				                  <p>These companies trust We are attentive to the needs of our customers, designing and building complexes that are right for them.</p>
				              </div>
				        </div>

				          <div class="m-news-slider m-team-slider">
				              <div class="swiper">
...
<!-- Mirrored from capdeal.io/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2024 04:17:39 GMT -->
</html>