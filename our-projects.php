	...
	<div class="viewport">
		<div id="scroll-container">
            ...
            <div class="m-caption__primary__text">
              <div class="text-revel-box"><h1 class="text-revel-3">Our Old <span class="text-primary">Projects</span></h1></div>
            ...
            <div class="m-project-items">
              <div class="m-project-item">
                <a href="cosmopolis.html"></a>
                <div class="m-project-item-media">
                  <img src="img/projects/pro-cosmo.jpg" alt="Cosmopolis">
                </div>
                <h4>COSMOPOLIS</h4>
                <p>Capdeal got associated with Assotech Limited in 2015 for the resale prospect of its project, Cosmopolis. It must be a record in secondary sales in any project.</p>
              </div>
               
              <div class="m-project-item">
                <a href="group-g.html"></a>
                <div class="m-project-item-media">
                  <img src="img/projects/pro-grand_awaas.jpg" alt="Group G">
                </div>
                <h4>Group G</h4>
                <p>2021 was an ultimate test of human resilience. Amidst the Covid-19 crisis, reviving an underrated project and creating a fresh perspective is an intricate process.</p>
              </div>
              <div class="m-project-item">
                <a href="evos-sea-roses.html"></a>
                <div class="m-project-item-media">
                  <img src="img/projects/pro-sea_rose.jpg" alt="Evos Sea Roses">
                </div>
                <h4>EVOS SEA ROSES</h4>
                <p>Evos Sea Roses is a luxury project by developer Evos Buildcon that offers premium quality sea-facing lavish apartments.</p>
              </div>
            </div>
...
<!-- Mirrored from capdeal.io/our-projects.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2024 04:17:44 GMT -->
</html>