	...
	<div class="viewport">
		<div id="scroll-container">
			...
			<div class="m-inner-page-banner">
				<!-- <img src="img/news_press_banner.jpg" alt=""> -->
			...
			<div class="m-inner-page-content">
				<!-- <div class="m-about-sec1">
					<div class="m-caption__primary__text mb-0">
			            <div class="text-revel-box"><h3 class="text-revel-3">Step into <span class="text-primary">the World of Capdeal</span></h3></div>
...
<!-- Mirrored from capdeal.io/terms-and-conditions.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2024 04:17:58 GMT -->
</html>