	...
	<div class="viewport">
		<div id="scroll-container">
			...
			<div class="m-inner-page-banner">
				<img src="img/founder-banner.jpg" alt="Founder Banner">
				<div class="m-page-title">
					<h2>Founder's Message</h2>
				</div>
			</div>
			<div class="m-inner-page-content founder-msg">
				<div class="m-container-narrow">
					<div class="m-caption__primary__text mb-0">
			            <div class="text-revel-box"><h3 class="text-revel-3 mb-0"><span class="text-primary">Mr Sakti Swarup Mishra</span></h3></div>
			            <h4 class="mb-4">Founder, CEO</h4>
		              	<div class="m-section__content__desc">
		                  <p>“From the day we started Capdeal, our vision was to maintain a standard approach for every type of product, big or small. We put all our heart, thoughts and ideas into making every real estate transaction fruitful. And I am proud to say that we have been extremely successful in achieving that.”</p>
		                  <p>Sakti Mishra is the founder and CEO of Capdeal-Easy Real Estate. He has over 2 decades of experience in real estate markets and is a trusted adviser to developers, occupiers and investors. He is widely acknowledged for revolutionising the sector with his visionary outlook and technology-based solutions. Sakti set up Capdeal in 2015. Under his leadership, Capdeal is now the undisputed leading name in real estate services in Odisha.</p>
		              	</div>
			        </div>
				</div>
...
<!-- Mirrored from capdeal.io/founder-message.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2024 04:17:41 GMT -->
</html>