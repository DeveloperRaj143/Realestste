	...
	<div class="viewport">
		<div id="scroll-container">
			...
			<div class="m-inner-page-banner">
				<img src="img/project-banner.jpg" alt="Project Banner">
				<div class="m-page-title">
					<h2>Our Projects</h2>
				</div>
			</div>
			<div class="m-inner-page-content m-about-sec4 m-projects">
				  <div class="m-container">
            <div class="m-caption__primary__text">
              <div class="text-revel-box"><h1 class="text-revel-3">Our Ongoing <span class="text-primary">Projects</span></h1></div>
            ...
            <div class="m-project-items">
               
              <div class="m-project-item">
                <a href="assotech-pride.html"></a>
                <div class="m-project-item-media">
                  <img src="img/projects/pro-pride.jpg" alt="Assotech Pride">
                </div>
                <h4>ASSOTECH PRIDE</h4>
                <!--<p>Capdeal is the first realty in the history of Bhubaneswar to take the exclusive sales rights of a particular real estate project.</p>-->
              </div>
              
              <div class="m-project-item">
                <a href="assotech-blith.html"></a>
                <div class="m-project-item-media">
                  <img src="img/projects/blith.png" alt="Assotech Blith">
                </div>
                <h4>ASSOTECH Blith</h4>
              </div>
              
              <div class="m-project-item">
                <a href="assotech-nest.html"></a>
                <div class="m-project-item-media">
                  <img src="img/projects/nest.png" alt="Assotech Pride">
                </div>
                <h4>ASSOTECH Nest</h4>
              </div>
              <div class="m-project-item">
                <a href="assotech-hills.html"></a>
                <div class="m-project-item-media">
                  <img src="img/projects/hills.png" alt="Assotech Pride">
                </div>
                <h4>ASSOTECH Hills</h4>
              </div>
              
              <div class="m-project-item">
                <a href="saswat-riverside.html"></a>
                <div class="m-project-item-media">
                  <img src="img/projects/saswat-riverside.png" alt="Assotech Pride">
                </div>
                <h4>Saswat Riverside</h4>
              </div>
              
              <div class="m-project-item">
                <a href="avinash-capitalhomes-2.html"></a>
                <div class="m-project-item-media">
                  <img src="img/projects/avinash-capital-homes.png" alt="Assotech Pride">
                </div>
                <h4>AVINASH CAPITAL HOMES - 2</h4>
              </div>
              
              <div class="m-project-item">
                <a href="avinash-smart-city.html"></a>
                <div class="m-project-item-media">
                  <img src="img/projects/avinash-smart-city.png" alt="Assotech Pride">
                </div>
                <h4>Avinash Smart City Apartment</h4>
              </div>
              
              <div class="m-project-item">
                <a href="mapple-tree.html"></a>
                <div class="m-project-item-media">
                  <img src="img/projects/mapple-tree.png" alt="Assotech Pride">
                </div>
                <h4>Mapple Tree</h4>
              </div>
           ...
           <!--  <div class="m-project-more">
              <a href="#!" class="m-btn"> 
                <svg xmlns="http://www.w3.org/2000/svg" height="40" width="40"><path d="M20 32.542 7.458 20l1.417-1.417L19 28.708V7.458h2v21.25l10.125-10.125L32.542 20Z"/></svg>
                <span>Load More</span>
              </a>
            </div> -->
...
<!-- Mirrored from capdeal.io/ongoing-projects.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2024 04:17:48 GMT -->
</html>